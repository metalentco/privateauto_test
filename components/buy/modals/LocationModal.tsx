const LocationModal = () => {
  return (
    <div className="absolute top-[40px] left-[0px] w-[340px] py-6 bg-white text-base text-[#212529] border-2 shadow-2xl rounded-lg">
      <div className="w-full px-6 pb-8 space-y-4">
        <div className="text-left">
          ...
          <input
            type="text"
            className="form-control block w-full px-3 py-1.5 text-sm font-medium text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
