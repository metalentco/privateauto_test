...
const MilesModal = ({
  ...
  return (
    <div className="absolute top-[50px] left-[-170px] vs:left-[-300px] sm:left-[-80px] md:left-[0px] w-[305px] vs:w-[358px] py-6 bg-white text-base text-[#212529] border-2 shadow-2xl rounded-lg z-20">
